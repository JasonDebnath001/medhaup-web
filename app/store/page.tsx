...
export const metadata: Metadata = {
  ...
  description:
    "Buy medhaup study material for WBJEE ANM/GNM — guidebooks, printed chapter notes and full-length mock test series. Order on WhatsApp, delivered across West Bengal.",
};
