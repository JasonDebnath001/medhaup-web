...
const INFO_BAR = [
  { icon: CalendarRange, label: "Duration", value: "12 Months" },
  { icon: Wifi, label: "Mode", value: "100% Online" },
  { icon: Languages, label: "Language", value: "Bengali + English" },
  { icon: IndianRupee, label: "Full Course", value: "₹1,800 · EMI" },
];
  ...
  return (
    <section className="relative overflow-hidden bg-navy pt-32 pb-16 sm:pt-40 sm:pb-20">
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6">
        ...
        >
          ANM/GNM CET{" "}
          <span className="text-orange">Complete Course</span>
        </motion.h1>
        ...
        >
          Everything you need to crack the exam in one place — live classes,
          mock tests, and doubt support for a full year. Taught in the
          languages the paper is written in.
        </motion.p>
        ...
        >
          {INFO_BAR.map((item) => (
            ...
            >
              <item.icon size={18} className="mx-auto text-orange" />
